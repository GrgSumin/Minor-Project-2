...
const addProduct = async (req, res) => {
  try {
    ...
    const { Title, Brand, Category, Price, Quantity, Image, Description } =
      req.body;
...
const updateProduct = async (req, res) => {
  ...
  try {
    res
      .status(200)
      .json(await Product.findByIdAndUpdate(productId, updates, { new: true }));
  } catch (error) {
    console.log(error);
...
//     const {minPrice, maxPrice, Category, Brand, Availability} = req.params;
